...
BUILD_ARCH="${BUILD_ARCH:-"arm64"}"  # or x86_64
...
# Set instance types based on architecture
if [ "$BUILD_ARCH" = "arm64" ]; then
  INSTANCE_TYPE="${INSTANCE_TYPE:-c8g.medium}"
  AMI_NAME_PREFIX="cpu-ml-ami-arm64"
else
  INSTANCE_TYPE="${INSTANCE_TYPE:-c8i.medium}"
