...
app = FastAPI(title="RAG Gateway", docs_url="/docs", redoc_url=None)
...
if serve is not None:
    try:
        from fastapi import FastAPI as __FastAPIMarker
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run("infra.fastapi_gateway:app", host=os.getenv("GATEWAY_BIND_HOST", "0.0.0.0"), port=int(os.getenv("GATEWAY_PORT", "8003")), log_level=os.getenv("LOG_LEVEL", "info"))
